...
Unmaintained FOSS exists, no doubt, but it is nearly trivial to _begin_ maintaining an abandoned piece of available software (getting it to actually build correctly is another thing...)
