...
I've been expecting this for a while, of course, hence my obsession with backups and [continuous integration]({{< ref "/posts/too-much-ci.md" >}}), which offers some kind of guarantee that moving to another machine won't break everything I'm working on.
